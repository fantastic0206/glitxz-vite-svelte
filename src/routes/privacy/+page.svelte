<script>
	// useHead({
	//   title: "Privacy Policy @ HarrSoft Studio",
	// });
</script>
...
<div id="privacy-policy-page">
	...
	<div>
		<em>
			This Privacy Policy governs the manner in which we collect, use, maintain, and disclose
			information collected from users (each, a "User") of our website (the "Site") and any related
			services offered by us. This privacy policy applies to the Site and all products and services
			offered by us.
		</em>
		...
		<p>
			...
			but not limited to, when Users visit our site, register on the site, place an order, fill out
			a form, respond to a survey, and in connection with other activities, services, features, or
			resources we make available on our Site. Users may be asked for, as appropriate, name, email
			address, mailing address, phone number, and credit card information. We will collect personal
			identification information from Users only if they voluntarily submit such information to us.
			Users can always refuse to supply personal identification information, though that may prevent
		...
		<p>
			Our Site may use "cookies" to enhance the User experience. Users' web browsers place cookies
			on their hard drive for record-keeping purposes and sometimes to track information about them.
			Users may choose to set their web browser to refuse cookies or to alert them when cookies are
		...
		<p>
			...
			Site. We continually research how to improve the security of our web infrastructure. We review
			and assess known security flaws in libraries We may use before integrating them. Up-to-date
			security measures are of paramount importance to us, and we act promptly to address any
			security incidents or known exploits.
		</p>
		...
		<p>
			Users may find advertising or other content on our Site that links to the sites and services
			...
			interaction on any other website, including websites that have a link to our Site, is subject
		...
		<p>
			...
			how we are helping to protect the personal information I collect. You acknowledge and agree
			that it is your responsibility to review
		</p>
		<div class="bite-size">
			<!-- <BoxAlmond flavor="cool"> -->
			<em>Last updated: March 27, 2023</em>
			<!-- </BoxAlmond> -->
		</div>
	</div>
	<!-- </BackgroundTexture> -->
